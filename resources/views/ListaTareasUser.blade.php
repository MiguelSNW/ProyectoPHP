...
<body>
    <div class="container mt-5">
        ...
        <div class="pagination">
            @if ($paginaActual > 1)
                <a href="{{ route('lista_tareasuser', ['pagina' => $paginaActual - 1]) }}" class="btn btn-primary">Anterior</a>
            @endif

            @if ($paginaActual < $totalPaginas)
                <a href="{{ route('lista_tareasuser', ['pagina' => $paginaActual + 1]) }}" class="btn btn-primary">Siguiente</a>
            @endif
        </div>
    </div>
